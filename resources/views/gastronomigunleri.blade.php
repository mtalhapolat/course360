...
<main class="main-content">
    <header class="header">
        <div style="display: flex; align-items: center; gap: 1.5rem;">
            ...
            <div>
                <h1 class="pageheader">Gastronomi Günleri</h1>
    ...
    <h2 style="margin-bottom: 1rem; font-size: 1.5rem; font-weight: 600;">Gastronomi Günleri Etkinlikleri</h2>
    <p>Başvuruya açık toplam <b>{{$events->count()}}</b> gastronomi etkinliğimiz bulunmaktadır.</p> <br>
