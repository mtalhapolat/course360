        ...
        <div class="container">
            ...
            <div class="school-list">
                @foreach($enrollments as $enrollment)
                    @php($student = $enrollment->getStudentKinderGarten($enrollment->student_id))
                    <div class="school-card selected" data-enroll="{{$enrollment->id}}">
                        <div class="school-header">
                            <h3 class="school-name">{{$student->name}} {{$student->surname}}</h3>
                            @if($enrollment->documents_statu == 0)
                                <div class="quota" onclick="window.location.href='/yuvamiz-beyoglu/6?enrollid={{$enrollment->id}}'">BELGE YÜKLE</div>
                            @elseif($enrollment->statu == 0)
                                <div class="quota">Onay Bekliyor</div>
                            @elseif($enrollment->statu == 1)
                                <div class="quota">Kesin Kaydınız Yapıldı</div>
                            @endif
                        ...
                        <div class="school-address">
                            ...
                            {{$enrollment->getSchoolKinderGarten($enrollment->school_id)->title}} <br>
                            {{$enrollment->getGroupKinderGarten($enrollment->group_id)->title}}
                        </div>
                    </div>
                @endforeach
            </div>
