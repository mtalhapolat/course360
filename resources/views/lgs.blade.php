...
<main class="main-content">
    <header class="header">
        <div style="display: flex; align-items: center; gap: 1.5rem;">
            ...
            <div>
                <h1 class="pageheader">LGS Kurs ve Etkinliklerimiz</h1>
    ...
    <h2 style="margin-bottom: 1rem; font-size: 1.5rem; font-weight: 600;">LGS Kurslar ve Etkinlikler</h2>
    <p>Başvuruya açık toplam <b>{{$events->count()+$lessons->count()}}</b> LGS kurs ve etkinliğimiz bulunmaktadır.</p> <br>
