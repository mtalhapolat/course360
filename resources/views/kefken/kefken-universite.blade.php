...
<main class="main-content">
    ...
    <div class="form-container">
        ...
        <div style="text-align: center">
            <img src="kefken-universite.png" style="height: 100px" alt="">
        </div>
        <h1 class="formheader">Üniversite Grubu Kefken Kampı Başvurusu</h1> <br>

        @if(\Carbon\Carbon::parse($student->birthday)->age < 18 || \Carbon\Carbon::parse($student->birthday)->age > 23)

            <p style="text-align: center">Üniversite grubu kefken kampı 18 - 23 yaş arası öğrencilerimiz içindir.</p>
        ...
        @else
            ...
            <form id="kefkenForm">
                ...
                <div class="step active" data-step="1">
                    ...
                    <input type="text" id="student_surname" name="student_surname" value="{{$student->surname}}" required readonly>
                    <label for="student_identity">Kimlik Numarası:</label>
                    <input type="text" id="student_identity" name="student_identity" required pattern="\d{11}" value="{{$student->identity}}"
                           title="11 haneli TC Kimlik Numarası" readonly>
                    <label for="student_birthday">Doğum Tarihi:</label>
                    <input type="date" id="student_birthday" name="student_birthday" value="{{$student->birthday}}" required readonly>
                    <label for="student_phone">Telefon:</label>
                    <input type="text" id="student_phone" name="student_phone" value="{{$student->phone}}" required readonly>
                </div>
                    ...
                    <div class="radio-group" style="display: block">
                        <div class="radio-item kadin">
                            <input type="radio" id="visit_date" name="visit_date"
                                   value="2025-07-28" disabled>
                            <label for="visit_date">28 Temmuz - 1 Ağustos (Doldu)</label>
                        </div>
                        <br>
                        <div class="radio-item erkek">
                            <input type="radio" id="visit_date2" name="visit_date"
                                   value="2025-08-25" required>
                            <label for="visit_date2">25 Ağustos - 28 Ağustos</label>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function nextPrev(n) {
        ...
        if(n === 1 && currentStep === 2 && (document.getElementById('student_birthday').value > '2007-12-31' || document.getElementById('student_birthday').value < '2002-01-01')){
...
<script>
    document.getElementById('student_file').addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            if (!isPdf || !isValidMimeType) {
                alert('Lütfen PDF dosyası yükleyiniz.');
                e.target.value = ''; // Input'u temizle
                return;
            }

            console.log('Geçerli PDF dosyası seçildi:', file.name);
        }
    });
</script>
