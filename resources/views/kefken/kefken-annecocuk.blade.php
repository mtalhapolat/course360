...
<main class="main-content">
    ...
    <div class="form-container">
        ...
        <div style="text-align: center">
            <img src="kefken-annecocuk.png" style="height: 100px" alt="">
        </div>
        <h1 class="formheader">Anne - Çocuk Grubu Kefken Kampı Başvurusu</h1> <br>
        
        @if(1)
        
        <p style="text-align: center">Kontenjan dolmuştur. Yoğun ilginize teşekkür ederiz.</p>

            <div style="text-align: center; margin-top: 2rem">
                <img src="heart.png" style="width: 100px" alt="">
            </div>

        @elseif(\Carbon\Carbon::parse($student->birthday)->age < 18 || $student->gender == 1)

            <p style="text-align: center">Anne - Çocuk grubu için başvuruyu anne yapmalıdır. Başvuru yapmak için anne bilgileri ile uygulamaya giriş yapılmalıdır.</p>
        ...
        @else
            ...
            <form id="kefkenForm">
                ...
                <input type="hidden" id="student2_gender" name="student2_gender" value="">
                    <input type="hidden" id="parent_name" name="parent_name" value="{{$student->name}}" required >
                    <input type="hidden" id="parent_surname" name="parent_surname" value="{{$student->surname}}" required
                           >
                    <input type="hidden" id="parent_identity" name="parent_identity" required pattern="\d{11}"
                           value="{{$student->identity}}" title="11 haneli TC Kimlik Numarası" >
                    <input type="hidden" id="parent_birthday" name="parent_birthday" value="{{$student->birthday}}"
                           required >
                    <input type="hidden" id="parent_phone" name="parent_phone" value="{{$student->phone}}" required>
                <div class="step active" data-step="1">
                    ...
                    <input type="date" id="student_birthday" name="student_birthday" value="{{$student->birthday}}"
                           required readonly>
                    <label for="student_phone">Anne Telefon:</label>
                ...
                <div class="step" data-step="2">
                    <label for="student_count">Katılacak Çocuk Sayınız:</label>
                ...
                <div class="step" data-step="5">
                    ...
                    <label for="student4_identity">Kimlik Numarası:</label>
                ...
                <div class="step" data-step="7">
                    <h3>5. Çocuk Bilgileri</h3>
                    <label for="student6_name">Adı:</label>
                    <input type="text" id="student6_name" name="student6_name" value="" >
                    <label for="student6_surname">Soyadı:</label>
                    <input type="text" id="student6_surname" name="student6_surname" value="" >
                    ...
                    <input type="date" id="student6_birthday" name="student6_birthday" value="" >
                </div>
            ...
            <div style="margin-top: 5%">
                ...
                <p>Başvuru, anne tarafından yapılmalıdır. Katılacak tüm çocuklarınızın bilgileri girilmelidir.</p>
            </div>
...
<script>
    ...
    function nextPrev(n) {
        ...
        if(n === 1 && currentStep === 3 && document.getElementById('student2_birthday').value < '2015-01-01'){
            alert("Anne - Çocuk grubuna anne ile beraber 10 yaş ve altı çocuğu katılabilir.");
            exit;
        }
        if(n === 1 && currentStep === 4 && document.getElementById('student3_birthday').value < '2015-01-01'){
            alert("Anne - Çocuk grubuna anne ile beraber 10 yaş ve altı çocuğu katılabilir.");
            exit;
        }
        if(n === 1 && currentStep === 5 && document.getElementById('student4_birthday').value < '2015-01-01'){
            alert("Anne - Çocuk grubuna anne ile beraber 10 yaş ve altı çocuğu katılabilir.");
            exit;
        }
        if(n === 1 && currentStep === 6 && document.getElementById('student5_birthday').value < '2015-01-01'){
            alert("Anne - Çocuk grubuna anne ile beraber 10 yaş ve altı çocuğu katılabilir.");
            exit;
        }
        if(n === 1 && currentStep === 7 && document.getElementById('student6_birthday').value < '2015-01-01'){
            alert("Anne - Çocuk grubuna anne ile beraber 10 yaş ve altı çocuğu katılabilir.");
            exit;
        }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data === "kimlikhata") {
                        ...
                        window.stop();
                    } else if(data['birthyear'] < 1015) {
                        alert("Anne - Çocuk grubuna 10 yaş üstü çocuklar katılamamaktadır.");
                        window.stop();
                    } else {

                        let token2 = '@csrf';
                        token2 = token2.substr(42, 40);
                        identity2 = document.getElementById('parent_identity').value;
                        $.ajax({
                            type: "post",
                            url: `/kefkenenrollcheck`,
                            data: { _token: token2, identity: identity, identity2: identity2},
                            success: function (data) {
                                if (data === 'true') {
