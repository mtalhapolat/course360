...
<main class="main-content">
    ...
    <div class="form-container">
        ...
        <div style="text-align: center">
            <img src="kefken-balayi.png" style="height: 100px" alt="">
        </div>
        <h1 class="formheader">Kefken Balayı Başvurusu</h1> <br>

        @if(\Carbon\Carbon::parse($student->birthday)->age < 18)

            <p style="text-align: center">Kefken Balayı başvurusunu eşlerden birisi yapmalıdır. 18 yaş altı kişilerin başvuruları kabul edilmemektedir.</p>
        ...
        @elseif($student->town != 'beyoğlu')
            ...
            <p style="text-align: center">Kefken Balayı programı, Beyoğlu'nda ikamet eden vatandaşlarımız içindir.</p>
        ...
        @else
            ...
            <form id="kefkenForm">
                ...
                <div class="step" data-step="2">
                    <label for="marriage_date">Evlilik Tarihi:</label>
                    <input type="date" id="marriage_date" name="marriage_date" value=""
                           title="Evlilik tarihinizi giriniz." required>
                </div>
            ...
            <div style="margin-top: 5%">
                <h3 style="color: #8B0000">Başvuru Şartları</h3>
                <p>Çiftlerden birinin Beyoğlu ikametinin olması, 1 Haziran 2025 tarihinden sonra evlenmiş olmak, T.C. vatandaşı olmak. Ön kayıt yapıldıktan sonra Sosyal Yardım İşleri Müdürlüğü sosyal durumu gözeterek başvuruları değerlendirecektir.</p>
            </div>

            <div id="successMessage" style="display: none;">
                <div class="success-banner">Başvurunuz Alındı</div>
                <p class="thank-you-message">Kefken Balayı başvurunuz alınmıştır. Başvurunuz değerlendirildikten sonra
