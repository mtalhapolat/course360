...
<main class="main-content">
    <header class="header">
        <div style="display: flex; align-items: center; gap: 1.5rem;">
            ...
            <div>
                <h1 class="pageheader">Özgem Başvurusu</h1>
    ...
    <h2 style="margin-bottom: 1rem; font-size: 1.5rem; font-weight: 600;">Özgem Kurs ve Etkinlikler</h2>
    <p>Başvuruya açık toplam <b>{{$eventscount}}</b> Özgem Kurs / Etkinliğimiz bulunmaktadır.</p> <br>
    ...
    @if($request->s != null) Tüm kayıtları listelemek için <a href="/ozgem">tıklayınız</a> <br> <br> @endif
